...
VERSION = "v96.1-Album-Fix-Update"
    ...
    async with MAX_CONCURRENT_TASKS:
        ...
        try:
            ...
            if is_avatar_task:
                ...
                if not downloaded:
                    if is_dailymotion_url(target_url):
...
async def changelog_callback_handler(event):
    ...
    if data == "show_changelog":
        changelog_text = (
            ...
            "✨ **حل مشكلة ألبوم الصور (v96.1):** إصلاح خطأ `SendMediaRequest` عند رفع الصور كألبوم وتوحيد امتدادات الصور المعالجة.\n"
