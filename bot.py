...
async def start_handler(event):
    changelog_text = (
        ...
        "1️⃣ **التحكم بلقطات التواصل:** يمكنك الآن إيقاف/تفعيل التقاط 9 لقطات من روابط منصات التواصل من الإعدادات بلمسة زر.\n"
        "2️⃣ **الروابط المباشرة فقط:** حصر إرسال الصور التلقائية بالفيديوهات الآتية من الروابط المباشرة (افتراضياً).\n"
        "3️⃣ **إلغاء العمليات:** إمكانية إيقاف وإلغاء أي عملية تنزيل أو رفع فوراً عبر زر `❌ إلغاء العملية`.\n"
        "4️⃣ **توقيت اللقطات:** كتابة الوقت بوضوح أبيض شفاف في منتصف اللقطات بحجم قابل للتخصيص.\n"
...
def main():
    ...
    print("🤖 البوت يعمل بأعلى كفاءة مع الخيار الجديد لالتقاط صور الروابط المباشرة فقط!")
