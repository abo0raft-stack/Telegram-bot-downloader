...
async def start_handler(event):
    welcome_text = (
        ...
        "✨ **أرسل الرابط مباشرة للبدء (يدعم MP4, M3U8, YouTube...)!**"
    )
    ...
    try:
        ...
        if is_direct_mp4:
            try:
                ...
                is_m3u8 = True  # تحويله كخيار ثانٍ للـ yt-dlp في حال الفشل
                
        if is_m3u8 or not is_direct_mp4:
            # التعامل مع روابط m3u8 وجميع السيرفرات المجزأة عبر yt-dlp + ffmpeg
            ...
            ydl_opts = {
                ...
                'hls_prefer_native': True, # تسريع معالجة m3u8 تلقائياً
        ...
        if os.path.exists(file_path):
            ...
            if file_size < 50 * 1024: 
                raise Exception("الملف المحمل صغير جداً أو غير صالح.")
