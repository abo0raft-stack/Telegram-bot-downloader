...
VERSION = "v87.0-Smart-Resume-Direct-Engine"
...
# --- v87 التنزيل المباشر الذكي مع دعم الاستئناف والبث عبر HTTP Range & yt-dlp ---
...
async def start_handler(event):
    if not await is_allowed(event):
        ...
        return
    welcome_text = (
        "🤖 **أهلاً بك في بوت التنزيل المتقدم (v87)!**\n\n"
...
async def changelog_callback_handler(event):
    ...
    if data == "show_changelog":
        changelog_text = (
            ...
            "⚡ **دعم التنزيل المباشر المحسّن (v87):** دعم روابط MP4, M3U8, MPD, MKV والبث المباشر وتجزئتها بسلاسة عالية.\n"
            ...
            "🛠️ **إصلاح الأحداث المنقطعة:** إصلاح كامل لـ instagram_callback_handler وضبط إدارة قواعد البيانات المؤقتة.\n"
            "👤 **محرك الأفاتار (v86):** دعم جلب صورة البروفايل لجميع المنصات والواتساب.\n\n"
