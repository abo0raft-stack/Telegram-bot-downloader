...
# --- تنظيف الملفات المتبقية والذاكرة عند بدء التشغيل ---
...
# --- دالة التحميل المباشر مع الترويسات لمنع خطأ 403 ---
...
# --- التنفيذ الأساسي المحدث والمحسن لخفة الذاكرة ---
async def start_execution(chat_id, url, filename_title, as_doc=False, quality='best'):
    ...
    try:
        ...
        # --- تنظيف شامل ومباشر لتقليل استهلاك السيرفر والـ RAM ---
        ...
        # إجبار 파يثون على إفراغ الذاكرة العشوائية فوراً
        gc.collect()
