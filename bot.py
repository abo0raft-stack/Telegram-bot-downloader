...
async def changelog_callback_handler(event):
    ...
    if data == "show_changelog":
        changelog_text = (
            ...
            "📝 **وصول وصف المنشور مع الميديا:** استخراج وإرفاق نص المنشور المكتوب تلقائياً مع الفيديو أو الصور من منصات التواصل.\n"
            "🏷️ **اسم الملف للروابط المباشرة:** استخراج وعرض اسم الملف الحقيقي بدقة في رسالة الرفع للروابط المباشرة.\n"
            ...
            "🔴 **إصلاح التشغيل (MP4):** تحويل ومعالجة الفيديو لتصل قابلة للمشاهدة المباشرة.\n\n"
