...
# --- الإعدادات ---
VERSION = "v85.0-UniversalSmartVideo-Edition"
...
async def changelog_callback_handler(event):
    ...
    if data == "show_changelog":
        changelog_text = (
            ...
            "1️⃣ **التعرف الذكي لروابط الفيديو:** استخراج مباشر وموثوق للفيديوهات في أي موقع أو صفحة ويب.\n"
            "2️⃣ **أزرار اختيار الجودة الشاملة:** إضافة اختيار الخيارات (1080p - 720p - 480p - 360p - MP3 - مستند).\n"
            "3️⃣ **تعدد مكتبات السحب:** دمج yt-dlp, gallery-dl, BeautifulSoup و Cobalt للتحميل بدون خطأ.\n"
            "4️⃣ **الحفاظ على الخصائص المتقدمة:** التقاط الـ 9 صور، التقسيم عند 2GB، والقص التلقائي بنفس الكفاءة.\n\n"
