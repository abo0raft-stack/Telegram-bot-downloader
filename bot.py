...
# --- الإعدادات ---
VERSION = "v61.0-Fix-None-Extensions"
        ...
        for root, _, files in os.walk(task_dir):
            for file in files:
                ...
                if os.path.isfile(fpath) and os.path.getsize(fpath) > 500 and not file.endswith('_thumb.jpg'):
                    ...
                    # الكشف عن نوع الملف وتصحيح الاسم إذا كان None أو بدون امتداد
...
def main():
    ...
    print("🤖 البوت يعمل بكفاءة وتم تصحيح مسميات امتدادات الملفات المكسورة!")
