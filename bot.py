...
VERSION = "v99.4-Enhanced-Direct-Download"
...
async def changelog_callback_handler(event):
    ...
    if data == "show_changelog":
        changelog_text = (
            ...
            "🔄 **تحديث محرك التنزيل المباشر (v99.4):** دمج دالة `download_direct_url` المخصصة للتحميل المباشر وتفادي أخطاء الحظر HTTP 429 مع معالجة التقدم عبر `progress_callback`.\n"
