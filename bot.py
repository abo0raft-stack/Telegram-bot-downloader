...
# --- الإعدادات ---
VERSION = "v35.0-Fix487SafeUpload"
...
async def start_execution(chat_id, url, filename_title, as_doc=False, quality='best'):
    ...
    try:
        ...
        if os.path.exists(file_path):
            ...
            # تجنب توقف الكود إذا تعطلت عملية الللقطات
            if quality != 'audio':
                try:
                    ...
                    print(f"Shots Error Bypassed: {shot_err}")

            await status_msg.delete()

    except Exception as e:
        # إظهار النص البرمجي الحقيقي للاستثناء
