...
VERSION = "v99.0-TikTok-Engine-Overhaul"
...
async def changelog_callback_handler(event):
    ...
    if data == "show_changelog":
        changelog_text = (
            ...
            "🎵 **إصلاح دالة التنزيل من تيكتوك (v97):** إضافة محرك TikWM الهجين مع الدعم الكامل للفيديوهات، والسلاسل المصورة (Photos) واستخراج الصوت والوصف وترجمته.\n"
            ...
            "📱 **إضافة قائمة الأوامر التفاعلية (v95):** تسجيل قائمة الأوامر الرسمية تلقائياً في واجهة زر الأوامر بالتليجرام.\n"
            "🧠 **تحسين تفريغ الذاكرة والحجم الحقيقي (v94):** تفعيل محرك `malloc_trim` قسراً عبر مكتبة `libc` لتفريغ الذاكرة المحجوزة لنظام التشغيل.\n"
            "🛠️ **إدارة السيرفر والتنظيف الحقيقي (v93):** تحديث أمر `/df` وتطوير أمر `/clean` ليقوم بحذف فعلي لكافة الملفات المؤقتة وتفريغ الذاكرة.\n"
...
# --- إعداد قائمة الأوامر الرسمية للتليجرام عند بدء التشغيل ---
async def set_bot_commands():
    try:
        ...
        await bot(SetBotCommandsRequest(commands=commands))
    except Exception as e:
