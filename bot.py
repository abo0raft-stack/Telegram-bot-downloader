...
def fix_mp4_faststart(input_path, output_path):
    """إصلاح حاوية الفيديو وإضافة faststart للتشغيل المباشر وإظهار الوقت"""
    cmd = [
    ...
    try:
        if media_msg:
            ...
            if quality in ['1080', '720', '480', 'audio_mp3', 'mp3'] and url:
                ...
                # معالجة Faststart وإصلاح حاوية MP4 لإظهار شريط الدقائق بالتليجرام
