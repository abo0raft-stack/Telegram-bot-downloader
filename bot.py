...
# --- التحديث التلقائي للمكتبات (مع معالجة الآمان) ---
...
# --- الإعدادات ---
VERSION = "v79.0-Enhanced-Async-Edition"
...
# --- دوال تنزيل المنصات (بدون أي تعديل على منطقها الأصلي) ---
...
async def changelog_callback_handler(event):
    ...
    if data == "show_changelog":
        changelog_text = (
            ...
            "1️⃣ **تحسين الأداء Non-Blocking:** التنزيل المباشر باستخدام `aiohttp` لمنع تجميد الاستجابة.\n"
            "2️⃣ **قاعدة بيانات SQLite:** حفظ تفضيلات المستخدم والمهام بدون ضياع عند التحديث.\n"
            "3️⃣ **تقسيم الفيديوهات تلقائياً (Video Splitter):** تجزئة أوتوماتيكية للفيديوهات +1.9GB.\n"
            "4️⃣ **قص الفيديو (Video Trimmer):** قص مقطع زمني محدد باستخدام أمر `/trim`.\n"
            "5️⃣ **إدارة المتغيرات والإعدادات المتقدمة:** تحديث مزامنة قاعدة البيانات، تحسينات التقاط اللقطات التسع، والتعامل الذكي مع محركات Cobalt و Gallery-DL.\n\n"
...
def main():
    ...
    print("🤖 البوت يعمل بأعلى كفاءة مع تحديث قاعدة البيانات وقص/تقسيم الفيديو!")
