...
VERSION = "v83.0-Profile-Avatar-Support"
...
def is_profile_url(url):
    ...
    # فحص المنصات المعروفة لأنماط البروفايل
...
async def download_profile_avatar(url, task_dir):
    try:
        # المحاولة الأولى عبر gallery-dl بتحديد الفئة avatar
        cmd = [
            "gallery-dl",
            "--directory", task_dir,
        ...
        # المحاولة الثانية عبر yt-dlp لاستخراج الصورة الشخصية (avatar/thumbnail)
        ...
        # المحاولة الثالثة: الاستعانة بـ Cobalt API لاستخراج avatar
...
async def quality_callback_handler(event):
    ...
    # توجيه رابط Dailymotion إلى الدالة المخصصة له
