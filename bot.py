...
def is_complex_url(url):
    ...
    return any(x in domain for x in ['twitter.com', 'x.com', 'instagram.com', 'instagr.am', 'tiktok.com', 'vt.tiktok.com', 'facebook.com', 'fb.watch', 'fb.com'])
...
def main():
    ...
    print("🤖 البوت يعمل بأعلى كفاءة مع تحديث قاعدة البيانات وقص/تقسيم الفيديو وتنسيق الوقت!")
