    ...
    try:
        ...
        if is_direct_url:
            ...
            try:
                ...
                if "HTTP_403_FORBIDDEN" in str(direct_err) or "CANCELLED_BY_USER" not in str(direct_err):
                    await status_msg.edit("⚠️ **تم كشف حماية السيرفر، جاري التجاوز عبر yt-dlp المعزز...**")
