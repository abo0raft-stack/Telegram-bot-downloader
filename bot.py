...
VERSION = "v85.0-YouTube-Bypass-Fix"
...
# --- دالة التنزيل والرفع المخصصة لـ YouTube مع شريط التقدم ودعم الكوكيز وباي باس يوتيوب ---
async def download_youtube_video(event, url, quality_choice, status_msg):
    ...
    ydl_opts = {
        ...
        # --- حل مشكلة "The page needs to be reloaded" لعملاء يوتيوب ---
        'extractor_args': {
            'youtube': {
