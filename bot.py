...
# --- التحديث التلقائي للمكتبات لمنع أعطال إنستغرام وتيك توك ---
...
# --- الإعدادات ---
VERSION = "v65.0-TikTok-GalleryDL-Support"
...
async def start_direct_execution(chat_id, url, filename, as_doc=False, quality='best', media_msg=None, target_fmt='mp4', status_msg=None):
    ...
    try:
        ...
        if target_url and is_complex_url(target_url):
            ...
            # 3. في حالة تيك توك (استخدام gallery-dl لصور Photo Mode)
...
def main():
    ...
    print("🤖 البوت يعمل بكفاءة وتم إضافة gallery-dl لصور تيك توك!")
