...
VERSION = "v84.0-Add-User-Support[span_0](start_span)"[span_0](end_span)
...
# --- دالة مخصصة لتحميل الصورة الشخصية (Profile Picture) ---
...
async def changelog_callback_handler(event):
    ...
    if data == "show_changelog":
        changelog_text = (
            ...
            "👤 **تنزيل الصور الشخصية (Avatars):** دعم إرسال روابط الملفات الشخصية (Instagram, TikTok, X, YouTube, Pinterest) لتنزيل صورة البروفايل بأعلى جودة.\n"
            ...
            f"📌 الإصدار الحالي: `{VERSION}`[span_2](start_span)"[span_2](end_span)
        )
