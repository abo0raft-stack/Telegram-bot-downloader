...
VERSION = "v98.0-Video-Attribute-Fix"
        ...
        try:
            ...
            for vid_idx, vid in enumerate(videos, start=1):
                ...
                for idx, part_vid in enumerate(split_vids, start=1):
                    ...
                    # إصلاح وتعيين خصائص الفيديو بدقة لضمان الإرسال كمشغل فيديو وليس كصورة
...
async def set_bot_commands():
    try:
        ...
        print(f"Set Bot Commands Error: {e}")
