...
async def changelog_callback_handler(event):
    ...
    if data == "show_changelog":
        changelog_text = (
            ...
            "1️⃣ **إضافة منصات جديدة:** دعم شامل للتنزيل من Reddit, Pinterest, Threads, Snapchat, VK, و Vimeo[span_1](start_span)[span_1](end_span).\n"
            "2️⃣ **دعم معالجة الصور والألبومات:** سحب الوسائط المتعددة والألبومات بمرونة عالية لمنصات التواصل المضافة[span_2](start_span)[span_2](end_span).\n"
            "3️⃣ **تنسيق عرض الوقت:** تحويل عرض الوقت المنقضي والمتبقي تلقائياً إلى صيغة (دقائق وثوانٍ)[span_3](start_span)[span_3](end_span).\n"
            "4️⃣ **تحسين الأداء Non-Blocking:** التنزيل المباشر باستخدام `aiohttp` لمنع تجميد الاستجابة[span_4](start_span)[span_4](end_span).\n"
            "5️⃣ **تقسيم الفيديوهات تلقائياً (Video Splitter):** تجزئة أوتوماتيكية للفيديوهات +1.9GB[span_5](start_span)[span_5](end_span).\n"
            "6️⃣ **قص الفيديو (Video Trimmer):** قص مقطع زمني محدد باستخدام أمر `/trim`[span_6](start_span)[span_6](end_span).\n\n"
